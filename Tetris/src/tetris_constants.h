...
#define GAME_MODE_GHOST 1

#define LIGHT_MODE_NORMAL GAME_MODE_NORMAL
#define LIGHT_MODE_GHOST GAME_MODE_GHOST
...
#define TETRIMINO_STARTING_Y (BOARD_PLAYABLE_HEIGHT + 0)
